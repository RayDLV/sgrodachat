...
class MainActivity : AppCompatActivity() {
    ...
    private fun setup() {
        binding.apply {
            ...
            mMessagesAdapter.add(ChatMessageItem("Connettiti ad un altro dispositivo per iniziare una conversazione...", "Info", resources.getColor(R.color.white, null)))
    ...
    private fun setupBluetoothClientConnection() {
        ...
        allPairs.add(0, "Seleziona Connessione")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_ENABLE_BT && resultCode == RESULT_OK) {
            Snackbar.make(binding.root, "Dispositivo Bluetooth Abilitato", Snackbar.LENGTH_LONG).show()
        }
    }
    ...
    private inner class AcceptThread : Thread() {
        ...
        override fun run() {
            ...
            while (shouldLoop) {
                val socket: BluetoothSocket? = try {
                    Log.d(TAG, "Stabilendo Nuova Connessione...")
                    mmServerSocket?.accept()
                } catch (e: IOException) {
                    Log.e(TAG, "Accettazione del Socket() metodo fallito", e)
                    shouldLoop = false
                    null
                }
                socket?.also { bluetoothSocket ->
                    ...
                    mHandler.post {
                        ...
                        if (idx != -1) {
                            ...
                            binding.tvConnectionLabel.text = "Connesso A"
                        }
                        Snackbar.make(
                            binding.root,
                            "Connessione stabilita con $client",
                            Snackbar.LENGTH_LONG
                        ).show()
                    }
        ...
        fun cancel() {
            try {
                ...
                Log.e(TAG, "Non riesco a chiudere il socket di connessione", e)
            }
        }
    }
        ...
        public override fun run() {
            ...
            mmSocket?.let { socket ->
                ...
                try {
                    ...
                    Log.e(TAG, "Connessione stabilita con", e)
                }
    ...
    private inner class ConnectedThread(private val mmSocket: BluetoothSocket, val opName: String) :
        ...
        override fun run() {
            ...
            while (true) {
                ...
                numBytes = try {
                    ...
                    Log.d(TAG, "Stream di input disconnesso", e)
                    break
                }
        ...
        fun write(bytes: ByteArray) {
            try {
                ...
                Log.e(TAG, "Errore di invio dati", e)

                // Send a failure message back to the activity.
                val writeErrorMsg = mHandler.obtainMessage(MESSAGE_TOAST)
                val bundle = Bundle().apply {
                    putString("toast", "Impossibile inviare dati al destinatario")
                }
    ...
    private fun manageServerSocketConnection(socket: BluetoothSocket, name: String) {
        mHandler = Handler(this.mainLooper, Handler.Callback {
            try {
                ...
                Toast.makeText(this, "Nuovo Messaggio", Toast.LENGTH_SHORT).show()
